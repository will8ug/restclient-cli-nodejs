...
- [x] **Task 2.1: Define shared types**
...
- [x] **Task 2.2: Build .http file parser**
...
- [x] **Task 2.4: Build variable resolver**
...
- [x] **Task 3.2: Build App component with state management**
...
- [x] **Task 3.3: Build Layout component**
...
- [x] **Task 3.4: Build RequestList component**
...
- [x] **Task 3.5: Build ResponseView component**
